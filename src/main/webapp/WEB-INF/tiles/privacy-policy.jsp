...
<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
  ...
  Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://gruuf.com/</p>
...
<p>Data Controller means a person who (either alone or jointly or in common with other persons) determines the purposes
...
<p>Data Processor (or Service Provider) means any person (other than an employee of the Data Controller) who processes
  the data on behalf of the Data Controller.</p>
...
<h3>User</h3>
<p>The User is the individual using our Service. The User corresponds to the Data Subject, who is the subject of
  Personal Data.</p>
...
<p>We may use your Personal Data to contact you with newsletters, marketing or promotional materials and other
  ...
  by following the unsubscribe link or instructions provided in any email we send.</p>
...
<p>Uslugi IT Lukasz Lenart uses the collected data for various purposes:</p>
<ul>
...
<p>Uslugi IT Lukasz Lenart will retain your Personal Data only for as long as is necessary for the purposes set out in
...
<p>Uslugi IT Lukasz Lenart will also retain Usage Data for internal analysis purposes. Usage Data is generally retained
...
<p>If you are located outside Poland and choose to provide information to us, please note that we transfer the data,
  including Personal Data, to Poland and process it there.</p>
<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that
  transfer.</p>
<p>Uslugi IT Lukasz Lenart will take all steps reasonably necessary to ensure that your data is treated securely and in
...
<p>Under certain circumstances, Uslugi IT Lukasz Lenart may be required to disclose your Personal Data if required to do
  so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>

<h3>Legal Requirements</h3>
<p>Uslugi IT Lukasz Lenart may disclose your Personal Data in the good faith belief that such action is necessary
  to:</p>
<ul>
  <li>To comply with a legal obligation</li>
  <li>To protect and defend the rights or property of Uslugi IT Lukasz Lenart</li>
...
<h2>Your Rights</h2>
<p>Uslugi IT Lukasz Lenart aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of
  your Personal Data.</p>
<p>Whenever made possible, you can update your Personal Data directly within your account settings section. If you are
  unable to change your Personal Data, please contact us to make the required changes.</p>
...
<p>You have the right to data portability for the information you provide to Uslugi IT Lukasz Lenart. You can request to
  obtain a copy of your Personal Data in a commonly used electronic format so that you can manage and move it.</p>
...
<p>We do not knowingly collect personally identifiable information from anyone under the age of 13. If you are a parent
